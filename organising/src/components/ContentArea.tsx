...
const caseStudyPreloadImages = [
  ...
  userPersonaFormImg,
  addProductsTableImg,
  addProductsDetailImg,
  brandingStoreInfoImg,
  brandingColorImg,
  brandingColorCustomImg,
  brandingLogoImg,
  storefrontGeneratedImg,
  storefrontIntakeImg,
  domainReadyImg,
  launchOpsStoreManagementImg,
  launchOpsClientManagementImg,
  launchOpsCommerceImg,
  launchOpsJourneyImg,
  launchOpsCommunicationImg,
  brandSurfaceExampleImg,
  brandSurfaceVariationsImg,
  clientPortalImg,
  patientPortalImg,
  consentImg,
  userTestingImg,
  telehealthLaunchWorkflowImg,
  selectProductsBeforeImg,
  selectProductsAfterImg,
  navigationIaBeforeImg,
  navigationIaAfterImg,
  buildBrandBeforeImg,
  buildBrandAfterImg,
  colorBeforeImg,
  colorAfterImg,
